<script lang="ts">
	...
	import { setup, checkSetup } from '$lib/api';
...
<div class="page">
	<div class="form-container">
		...
		<form onsubmit={handleSetup}>
			...
			<div class="field">
				<label for="library">library path (optional — can be set via env var)</label>
				<input id="library" type="text" bind:value={libraryPath} placeholder="/path/to/ebooks" />
			</div>
			{#if error}
